...
#*** 	LIRCHauppauge Intercept config
#***
#*****************************************
  #*****************************************
    #***
...
############################
# LIRCHauppaugeIntercept Class definition
##########################

class LIRCHauppaugeIntercept(GizmoScriptDefault):
	"""
...
############################
# LIRCHauppaugeIntercept class end
##########################

# register the user script
LIRCHauppaugeIntercept()
